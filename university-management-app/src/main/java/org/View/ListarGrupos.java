 ...
 * @author alede
 */
public class ListarGrupos extends javax.swing.JFrame {
    ...
    public ListarGrupos() {
        ...
        controllerPopularTablas.popularTablaGrupos(tblGrupos);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Administrar Grupos");
        ...
        btnAgregar.setText("Agregar Grupo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarGrupos().setVisible(true);
            }
        });
    }
