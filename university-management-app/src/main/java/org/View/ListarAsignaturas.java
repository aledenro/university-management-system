 ...
 * @author alede
 */
public class ListarAsignaturas extends javax.swing.JFrame {
    ...
    public ListarAsignaturas() {
        ...
        controllerPopularTablas.popularTablaAsignaturas(tblAsignaturas);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Administrar Asignaturas");
        ...
        btnEditar.setText("Editar Asignatura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarAsignaturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarAsignaturas().setVisible(true);
            }
        });
    }
